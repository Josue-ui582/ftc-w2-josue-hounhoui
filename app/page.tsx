    ...
    <>
      <HeroSection>
        <div className="absolute inset-0 z-0">
          <div className="absolute top-[-200px] right-[-250px] md:right-[-200px] w-[400px] h-[400px] md:w-[500px] md:h-[500px] rounded-full border-[2rem] md:border-[4rem] border-gray-800"></div>
          ...
          <div className="absolute bottom-[-200px] left-[-250px] md:left-[-200px] w-[400px] h-[400px] md:w-[500px] md:h-[500px] rounded-full border-[2rem] md:border-[4rem] border-gray-800"></div>
        </div>
